...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference("Temperature.count") do
      post temperatures_url, params: { temperature: { chiller: @temperature.chiller, mf: @temperature.mf, mf_paper: @temperature.mf_paper, pr_paper: @temperature.pr_paper, time: @temperature.time, uf: @temperature.uf } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { chiller: @temperature.chiller, mf: @temperature.mf, mf_paper: @temperature.mf_paper, pr_paper: @temperature.pr_paper, time: @temperature.time, uf: @temperature.uf } }
